...
package com.ogau.widget.wheelselect.kankan.wheel.widget;

import java.util.LinkedList;
import java.util.List;

import com.ogau.R;
import com.ogau.widget.wheelselect.kankan.wheel.widget.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	// Wheel drawables
	private int wheelBackground = R.drawable.ogau_wheel_bg;
	private int wheelForeground = R.drawable.ogau_wheel_val;
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.ogau_wheel_province_line_border));
		// 设置线宽
